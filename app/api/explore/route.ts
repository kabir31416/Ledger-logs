...
import { expenseQuerySchema } from "@/lib/validation";
...
/**
 * GET /api/explore
 * Public, unauthenticated listing used by the Explore page. Same filter
 * shape as /api/expenses but intentionally NOT scoped to a single user -
 * it's a public catalog view, matching the "public detail page" requirement.
 */
